...
import static com.o2.edh.processors.mddif.encryption.PGPUtil.BLOCK_SIZE;
import static com.o2.edh.processors.mddif.encryption.PGPUtil.BUFFER_SIZE;
...
public class OpenPGPKeyBasedEncryptor implements Encryptor {
    ...
    private static class OpenPGPEncryptCallback implements StreamCallback {
        ...
        public void process(InputStream in, OutputStream out) throws IOException {
            ...
            final boolean isArmored = MDDIFEncryptContent.isPGPArmoredAlgorithm(algorithm);
